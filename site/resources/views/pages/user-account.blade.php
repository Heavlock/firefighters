                ...
                <div class="d-flex flex-wrap align-items-center justify-content-start p-1 mt-1">
                    <div>
                        <h5 class="p-0 m-0 mr-5">Срок окончания
                            действия: <span class="text-primary">{{\Carbon\Carbon::parse($user['subscriptions'][$index]['subscribetime'])->diffForHumans()}}</span> </h5>
                    </div>
                </div>
                <hr>
                <div class="d-flex flex-wrap align-items-start justify-content-around flex-column p-1 mt-1">
                    <button class="btn btn-warning rounded-0 width-200 mb-3">Обратная Связь</button>
                    <button class="btn btn-danger primary-bg-color rounded-0 width-200 mb-3">Прекратить Договор</button>
                </div>
            </div>
            <hr>
            <hr>
